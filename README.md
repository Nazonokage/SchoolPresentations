...
2. **Click the subject name** — it opens that subject's folder.
3. Inside, open:
...
| # | Subject | Code | Folder | Status |
|---|---------|------|--------|--------|
| 1 | 🖥️ Human-Computer Interaction 2 | `IT103` | [`HCI_ 2_IT103_C/`](HCI_%202_IT103_C/) | ✅ Ready |
...
| 2️⃣ | Click the subject name | Opens the folder |
...
- Clicking a subject heading always links to that subject's **folder root** — browse from there for anything not listed under "Key files."
- The 🚧 subjects above exist locally and will be uploaded/organized soon.
- This repo will keep growing — check back for updates.

---

## 🔀 Related Repo

Some of these subject folders are planned to become **branches** of a companion repository:
👉 **[Nazonokage/SchoolPresentations](https://github.com/Nazonokage/SchoolPresentations)**
