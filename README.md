...
<p align="center">
  ...
  <img alt="subjects" src="https://img.shields.io/badge/subjects-4%20of%208-blue">
...
| 2 | 🧮 Data Structures & Algorithms | `CC104` | [`CC104_DSA_C/`](CC104_DSA_C/) | [`Data_Structures_and_Algos`](https://github.com/Nazonokage/SchoolPresentations/tree/Data_Structures_and_Algos) | ✅ Ready |
| 3 | ☕ Object-Oriented Programming | `EL 101` | [`EL_101_OOP_C/`](EL_101_OOP_C/) | [`Object_Oriented_Programming`](https://github.com/Nazonokage/SchoolPresentations/tree/Object_Oriented_Programming) | ✅ Ready |
| 4 | 🗄️ Advanced Database | `DC104` | `DC104_AdvDatabase/` | [`Advanced_Database`](https://github.com/Nazonokage/SchoolPresentations/tree/Advanced_Database) | ✅ Ready |
...
- 🌿 **Also available as its own branch:** [`Data_Structures_and_Algos`](https://github.com/Nazonokage/SchoolPresentations/tree/Data_Structures_and_Algos)
...
- 🌿 **Also available as its own branch:** [`Object_Oriented_Programming`](https://github.com/Nazonokage/SchoolPresentations/tree/Object_Oriented_Programming)
...
### 4. 🗄️ Advanced Database (`DC104`)

SQL JOINs, Recovery & Backup, Node.js fundamentals, HTTP, MVC, CRUD projects, Express.js, Routing, RESTful APIs, Middleware & Sessions, MongoDB Intro + CRUD.

- 📄 **Lecture modules:** M6–M23 — SQL JOINs, Recovery, Backup/Recovery, Node.js Intro → HTTP → MVC → CRUD, Express Intro → Routing → REST APIs, Middleware/Sessions, MongoDB Intro + CRUD
- 📝 **Prelims / Midterms folders:** available in the branch
- 🌿 **Also available as its own branch:** [`Advanced_Database`](https://github.com/Nazonokage/SchoolPresentations/tree/Advanced_Database)

**Jump straight to (on the branch):**
- 🔗 [adv db M6 · SQL JOINs.html](https://github.com/Nazonokage/SchoolPresentations/blob/Advanced_Database/adv%20db%20M6%20%C2%B7%20SQL%20JOINs.html)
- 🟢 [M16_expressjs_intro.html](https://github.com/Nazonokage/SchoolPresentations/blob/Advanced_Database/M16_expressjs_intro.html)
- 🍃 [m23_mongodb_crud.html](https://github.com/Nazonokage/SchoolPresentations/blob/Advanced_Database/m23_mongodb_crud.html)
...
├── 📁 DC104_AdvDatabase/       → Advanced Database
...
| `Data_Structures_and_Algos` | DSA only | [View branch](https://github.com/Nazonokage/SchoolPresentations/tree/Data_Structures_and_Algos) |
| `Object_Oriented_Programming` | OOP only | [View branch](https://github.com/Nazonokage/SchoolPresentations/tree/Object_Oriented_Programming) |
| `Advanced_Database` | Advanced Database only | [View branch](https://github.com/Nazonokage/SchoolPresentations/tree/Advanced_Database) |
